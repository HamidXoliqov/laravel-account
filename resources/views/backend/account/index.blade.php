                                ...
                                <tbody>
                                    ...
                                    @foreach($accounts as $value)
                                        <tr>
                                            ...
                                            <td>          
                                                <a  class="btn btn-info" href="{{route('account.show',$value->id)}}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a  class="btn btn-warning" href="{{route('account.edit',$value->id)}}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <div style="display: inline-table;">    
                                                    {!! Form::open(['route' => ['account.destroy',$value->id],'method'=>'DELETE']) !!}
